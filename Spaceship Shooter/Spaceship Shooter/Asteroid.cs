...
namespace Spaceship_shooter
{
    class Asteroid
    {
        ...
        public void Update()
        {
            ...
            if (asteroid_x - (asteroid_texture.Width/2) < 0 || asteroid_x + (asteroid_texture.Width/2) > 800)
            {
                asteroid_vel_x = -asteroid_vel_x;
            }

            if (asteroid_y - (asteroid_texture.Height/2) < 0 || asteroid_y + (asteroid_texture.Height/2) > 480)
            {
